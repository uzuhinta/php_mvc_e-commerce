<div id="main">
    ...
    <card style=" top: 40%;left: 15%;">
        <form class="login-form" autocomplete="off" action="#">
            ...
            <input type="text" name="name" style="width:45%; float: left;" placeholder="Họ và tên" />
            <input type="text" name="phone" style="width:45%; float: right;" placeholder="SĐT" />
            ...
            <input type="password" name="password" style="width:45%; float: left;" placeholder="Mật khẩu" />
            <input type="password" name="resetPassword" style="width:45%; float: right;" placeholder="Xác nhận mật khẩu" />
